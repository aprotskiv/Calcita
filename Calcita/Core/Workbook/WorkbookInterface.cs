...
#elif ANDROID
using ControlType = Calcita.ReoGridView;
#endif // ANDROID
...
namespace Calcita
{
...
#endif // WINFORM || WPF
	{
		...
		void Save(System.IO.Stream stream, Calcita.IO.FileFormat fileFormat);
		...
		void Save(System.IO.Stream stream, Calcita.IO.FileFormat fileFormat, Encoding encoding);
		...
		void Load(System.IO.Stream stream, Calcita.IO.FileFormat fileFormat);
		...
		/// <param name="fileFormat">Specified file format used to read workbook data from stream.</param>
		/// <param name="encoding">Encoding used to read plain-text format workbook data from stream. (Optional)</param>
		void Load(System.IO.Stream stream, Calcita.IO.FileFormat fileFormat, Encoding encoding);
